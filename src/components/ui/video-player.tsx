                ...
                <div className="flex items-center gap-2 text-xs text-white">
                  ...
                  <div className="relative flex flex-1 items-center">
                    ...
                    <input
                      ...
                      className="h-1 w-full cursor-pointer appearance-none rounded-full bg-transparent outline-none [&::-webkit-slider-runnable-track]:h-1 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-thumb]:size-3 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white"
                      id="video-seek"
                      max={duration}
                      min={0}
                      onChange={(e) => {
